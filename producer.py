...
# KKafka host, port, and topic name are extracted from the configuration object.
...
if __name__ == "__main__":
    ...
    # The Kafka producer is initialized with the bootstrap server details and a serializer that converts messages to JSON format.
    ...
    ecommerce_website_name_list = ["www.daraz.com", "www.amazon.com", "www.flipkart.com", "www.snapdeal.com", "www.ebay.com"]
